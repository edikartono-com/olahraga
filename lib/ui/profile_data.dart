...
class ProfileData extends StatefulWidget {
  ...
  const ProfileData({Key? key, required this.accessToken}): super(key: key);
...
class _ProfileData extends State<ProfileData> {
  ...
  Future<Map<String, dynamic>> getUserData() async {
    dynamic userRes;
    userRes = await _dioHelper.getUserProfile(widget.accessToken);
    return userRes;
  }

  Future<void> logout() async {
    await _dioHelper.logout(widget.accessToken);
